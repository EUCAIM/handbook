[**5. Data Preparation process 1**](#data-preparation-process)

> [5.1. Data preparation and related tools from the EUCAIM catalogue
> 3](#data-preparation-and-related-tools-from-the-eucaim-catalogue)
>
> [5.1.1. Access to the EUCAIM Software artifacts registry (Harbor)
> 5](#_heading=)
>
> [5.1.2. Access to the EUCAIM drive repository 5](#_heading=)
>
> [5.2. Tier 1 datasets 5](#tier-1-datasets)
>
> [5.2.1. Steps to prepare your Tier 1 dataset for transfer to a
> reference node
> 5](#steps-to-prepare-your-tier-1-dataset-for-transfer-to-a-reference-node)
>
> [5.2.1.1. Step 1: Image annotation (optional)
> 6](#step-1-image-annotation-optional)
>
> [5.2.1.2. Step 2: De-identification 6](#step-2-de-identification)
>
> [5.2.1.3. Step 3: Data quality check 8](#step-3-data-quality-check)
>
> [5.2.1.4. Step 4: Data transfer 9](#step-4-data-transfer)
>
> [5.3. Tiers 2 & 3 datasets 9](#tiers-2-3-datasets)
>
> [5.3.1. EUCAIM Common Data Model and Hyperontology
> 9](#eucaim-common-data-model-and-hyperontology)
>
> [5.3.2. Steps to prepare your Tier 2 or Tier 3 dataset to follow the
> EUCAIM CDM
> 10](#steps-to-prepare-your-tier-2-or-tier-3-dataset-to-follow-the-eucaim-cdm)
>
> [5.3.2.1. Step 1: Clinical data structuring
> 10](#step-1-clinical-data-structuring)
>
> [5.3.2.2. Step 2: Imaging correspondence with clinical data
> 12](#step-2-imaging-correspondence-with-clinical-data)
>
> [5.3.2.3. Step 3: image annotation (optional)
> 14](#step-3-image-annotation-optional)
>
> [5.3.2.4. Step 4: De-identification 15](#step-4-de-identification)
>
> [5.3.2.5. Step 5: Data quality assessment
> 16](#step-5-data-quality-assessment)
>
> [5.3.2.6. Step 6: Data conversion to EUCAIM Common Data Model
> 16](#step-6-data-conversion-to-eucaim-common-data-model)
>
> [5.3.2.7. Step 7: Data transfer (optional)
> 18](#step-7-data-transfer-optional)
>
> [5.4. Metadata registration in the public catalogue (mandatory)
> 18](#metadata-registration-in-the-public-catalogue-mandatory)
